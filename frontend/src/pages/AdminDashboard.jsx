...
<img alt="Admin Avatar" className="rounded-full" data-alt="close up professional headshot of a mature administrative director with a confident smile in a modern office setting" src="https://lh3.googleusercontent.com/aida-public/AB6AXuD1reNdQIg-JytzY4WUmSnOo7iGAjol5cODZ9Z_C5bGeIWCuB5C4m7Ptsr2taLwmK8go272DO0HvnZKRV9ZUB94CGrcwIJWnxTKeJsbXSwRJFAD0aZLmszU8OMpFUU_V5wYMEp0PZrriNCT46MVP38eMBthg4DX_8QMPDeW7LR4MtVIIa1WGxZDfZIY9IqKoOkop_xLb-OkL2t3BUNy09FLvDgpiffDMRpwJ9f_lGrIL6pbxzGcSUldA6CLANQ2C5564Q9ZNSK6Ak0"/>
</div>
<div>
...
<a className="flex items-center gap-3 text-slate-400 hover:text-white px-4 py-3 hover:bg-white/5 transition-all duration-300" href="#">
<span className="material-symbols-outlined" data-icon="dashboard">dashboard</span>
<span className="font-['DM_Sans'] text-sm uppercase tracking-widest">Overview</span>
</a>
<a className="flex items-center gap-3 text-white bg-[#1DB887] rounded-xl px-4 py-3 transition-all duration-300" href="#">
...
<span className="font-['DM_Sans'] text-sm uppercase tracking-widest">Manage Services</span>
</a>
<a className="flex items-center gap-3 text-slate-400 hover:text-white px-4 py-3 hover:bg-white/5 transition-all duration-300" href="#">
<span className="material-symbols-outlined" data-icon="group">group</span>
<span className="font-['DM_Sans'] text-sm uppercase tracking-widest">Users</span>
</a>
<a className="flex items-center gap-3 text-slate-400 hover:text-white px-4 py-3 hover:bg-white/5 transition-all duration-300" href="#">
<span className="material-symbols-outlined" data-icon="settings_accessibility">settings_accessibility</span>
<span className="font-['DM_Sans'] text-sm uppercase tracking-widest">Settings</span>
</a>
</nav>
...
<h1 className="font-['Syne'] text-3xl font-bold text-primary tracking-tight">Business Verification Queue</h1>
</div>
...
<div className="bg-surface-container-lowest rounded-[20px] editorial-shadow overflow-hidden border border-primary/5">
...
<div className="col-span-2 bg-primary p-10 rounded-[20px] relative overflow-hidden text-white flex items-center">
...
<div className="bg-surface-container-high p-8 rounded-[20px] border border-primary/5 flex flex-col justify-between">
<div>
<div className="flex items-center gap-2 mb-4">
<span className="material-symbols-outlined text-amber-500" data-icon="priority_high" data-weight="fill">priority_high</span>
