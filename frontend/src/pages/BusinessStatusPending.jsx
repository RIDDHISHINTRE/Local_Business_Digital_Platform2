...
<div className="font-['Bricolage_Grotesque'] text-2xl font-extrabold text-[#1B2A5E] dark:text-white">LocalBoost</div>
<div className="hidden md:flex items-center space-x-8">
<a className="font-ui text-sm font-medium tracking-tight text-[#1B2A5E] dark:text-slate-300 hover:text-[#1DB887] transition-colors" href="#">Services</a>
<a className="font-ui text-sm font-medium tracking-tight text-[#1DB887] font-bold border-b-2 border-[#1DB887] pb-1" href="#">My Business</a>
<a className="font-ui text-sm font-medium tracking-tight text-[#1B2A5E] dark:text-slate-300 hover:text-[#1DB887] transition-colors" href="#">Pricing</a>
<a className="font-ui text-sm font-medium tracking-tight text-[#1B2A5E] dark:text-slate-300 hover:text-[#1DB887] transition-colors" href="#">About</a>
</div>
<div className="flex items-center space-x-4">
<Link to="/sign-in" className="font-ui text-sm font-medium tracking-tight text-[#1B2A5E] hover:opacity-80 transition-all duration-200">Sign In</Link>
<Link to="/flow" className="bg-[#1B2A5E] text-white px-6 py-2 rounded-lg font-ui text-sm font-medium tracking-tight active:scale-95 transition-transform">Get Started</Link>
</div>
</div>
...
<span className="font-ui text-[11px] font-bold tracking-[0.2em] text-secondary uppercase mb-4 block">Verification Dashboard</span>
...
<h2 className="font-display text-2xl font-bold text-primary leading-tight">Your business is under verification</h2>
...
<div className="text-xs font-ui uppercase tracking-widest text-on-surface-variant font-bold">Verification<br/>Complete</div>
</div>
</div>
</div>
...
<div>
<h3 className="font-display text-lg font-bold text-primary">Account created</h3>
...
<div>
<h3 className="font-display text-lg font-bold text-primary">Service selected</h3>
...
<div>
<h3 className="font-display text-lg font-bold text-primary">Admin verification</h3>
...
<div>
<h3 className="font-display text-lg font-bold text-outline">Go live</h3>
...
<h4 className="font-display text-xl font-bold text-primary">Optimize your SEO while you wait.</h4>
...
<h4 className="font-display text-2xl font-bold text-white mb-2">Join a community of 50,000+ merchants</h4>
...
<a className="font-ui text-xs text-[#1B2A5E] dark:text-slate-400 hover:text-[#1DB887] transition-colors cursor-pointer" href="#">Privacy Policy</a>
<a className="font-ui text-xs text-[#1B2A5E] dark:text-slate-400 hover:text-[#1DB887] transition-colors cursor-pointer" href="#">Terms of Service</a>
<a className="font-ui text-xs text-[#1B2A5E] dark:text-slate-400 hover:text-[#1DB887] transition-colors cursor-pointer" href="#">Cookie Policy</a>
<a className="font-ui text-xs text-[#1B2A5E] dark:text-slate-400 hover:text-[#1DB887] transition-colors cursor-pointer" href="#">Support</a>
</div>
</div>
</footer>
